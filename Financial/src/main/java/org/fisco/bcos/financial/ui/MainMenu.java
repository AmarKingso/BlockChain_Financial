...
public class MainMenu extends JFrame implements ActionListener{
	 ...
	 * Create the frame.
	 */
	public MainMenu(FinancialClient c) {
		client = c;
	...
	public void actionPerformed(ActionEvent arg0) {
		if(arg0.getActionCommand() == "签订单据") {
			new FunctionsView(client, arg0.getActionCommand(), true, true);
		}
		else if(arg0.getActionCommand() == "转让单据") {
			new FunctionsView(client, arg0.getActionCommand(), true, true);
		}
		else if(arg0.getActionCommand() == "申请融资") {
			new FunctionsView(client, arg0.getActionCommand(), false, true);
		}
		else if(arg0.getActionCommand() == "结算支付") {
			new FunctionsView(client, arg0.getActionCommand(), true, false);
		}
		else {
			new SignIn();
			this.dispose();
